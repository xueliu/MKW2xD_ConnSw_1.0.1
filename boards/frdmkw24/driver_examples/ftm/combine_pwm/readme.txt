Overview
========
The FPM project is a demonstration program of generating a combined PWM signal by the SDK FPM driver. It sets up the FPM
...
On boards that have 2 LEDs connected to the FPM pins, the user will see a change in LED brightness.
