Overview
========
The FPM project is a demonstration program of the SDK FPM driver's input capture feature.
The example sets up a FPM channel for dual-edge capture. Once the input signal is received,
