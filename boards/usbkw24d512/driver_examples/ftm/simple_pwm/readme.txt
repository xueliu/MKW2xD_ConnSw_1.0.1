Overview
========
The FPM project is a simple demonstration program of the SDK FPM driver. It sets up the FPM
hardware block to output a center-aligned PWM signal. The PWM dutycycle is periodically updated.
On boards that have an LED connected to the FPM pins, the user will see a change in LED brightness.
