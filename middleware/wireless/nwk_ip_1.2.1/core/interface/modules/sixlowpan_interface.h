...
* \brief      This is a header file for the 6LowPan interface.
*
...
typedef bool_t (* getNextSleepyDev_t) (uint16_t* address);
typedef bool_t (* checkSleepyMcast_t) (uint16_t shortAddress, ipAddr_t *pIpAddr);
...
\fn     void SLWP_RegisterMgmtFunc(instanceId_t slwpInstanceId, isSleepyDev_t pfIsSleepyDev,
                  getNextSleepyDev_t pfGetNextSleepyDev, checkSleepyMcast_t pfCheckSleepyMcast)
\brief  Interface function for the 6LoWPAN module. It registers the callbacks for the 6LoWPAN.

\param  [in]    slwpInstanceId      6LoWPAN instance ID
\param  [in]    pfIsSleepyDev       Pointer to IsSleepyDevice function
\param  [in]    pfGetNextSleepyDev  Pointer to GetNextSleepyDevice function
\param  [in]    pfCheckSleepyMcast  Pointer to CheckSleepyMcast function
***************************************************************************************************/
