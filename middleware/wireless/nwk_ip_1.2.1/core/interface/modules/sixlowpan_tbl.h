/*!
* \file       sixlowpan_tbl.c
* \brief      This is a header file for the 6LowPan Table Manager.
*
...
/*!*************************************************************************************************
\fn     slwpPktInfo_t * RFC4944_IndTxQueueGet(uint8_t msduHandle, instanceId_t instanceId)
...
\return         slwpPktInfo_t   The Tx queue element.
***************************************************************************************************/
slwpPktInfo_t * RFC4944_IndTxQueueGet(uint8_t msduHandle, instanceId_t instanceId);
...
\return         slwpPktInfo_t   The Tx queue element.
***************************************************************************************************/
slwpPktInfo_t * RFC4944_IndTxQueueGetByDest(uint64_t address, uint8_t addMode, uint16_t panId,
                                            instanceId_t instanceId);
